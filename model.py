...
def score_all_models(X_train, y_train, X_val, y_val):
    '''
    ...
    dt_model = DecisionTreeClassifier(max_depth=15, random_state=123)
    rf_model = RandomForestClassifier(max_depth=15, random_state=123)
