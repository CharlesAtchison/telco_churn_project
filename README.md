...
<h1 name="project_summary" style="border-top: 10px groove tan border-bottom: 10px groove tan;">Project Summary</h1><hr style="border-top: 10px groove blueviolet; margin-top: 1px; margin-bottom: 1px"></hr>
